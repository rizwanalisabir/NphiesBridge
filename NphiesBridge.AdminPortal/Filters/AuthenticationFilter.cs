...
namespace NphiesBridge.AdminPortal.Filters
{
    ...
    // Convenience attribute for easier use
    public class AdminAuthorizeAttribute : AuthenticationFilter
    {
        // Inherits all functionality from AuthenticationFilter
    }
}